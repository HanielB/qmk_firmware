...
/* See https://gist.github.com/pocketkk/ab50ff5012b8bf779d6267047e0e6bbc for 8
  ...
  const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /* Dvorak for Emacs
       ...
       +--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
       | CapsL  | A      | O      | E      | U      | I      | D      | H      | T      | N      | S      | Win  |
       +--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
       | LShift | ;      | Q      | J      | K      | X      | B      | M      | W      | V      | Z      | En/Sh  |
       +--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
       | En/Ctrl | RAlt   | OneHnd | Tb/Ctl | Lower  | SpcNav | SpcNav | Raise  | Tb/Ctl | Util   | Esc    | En/Ctrl |
       +--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
    */
    [_DV] = {
    ...
    */
    [_RAISE] = { /* RAISE */
      ...
      { _______, RESET  , _______, _______, LOWER  , TG_BMOS, TG_BMOS, _______, _______, _______, TO(_GAME), _______}
    },
