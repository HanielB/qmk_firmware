  ...
  const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [_DVORAK] = {
      ...
      { KC_CAPS, KC_A   , KC_O   , LT(_MOUSE, KC_E)   , KC_U   , KC_I   , KC_D   , KC_H   , LT(_LFTMOUSE, KC_T), KC_N   , KC_S   , KC_CAPS},
      { KC_LSFT, KC_SCLN, KC_Q   , KC_J   , KC_K   , KC_X   , KC_B   , KC_M   , KC_W   , KC_V   , KC_Z   , SFT_ENT},
      { GUI_ENT, KC_RALT, TPTG_OH, CTL_TAB, LOWER  , MV_SPC , MV_SPC , RAISE  , CTL_TAB, UTIL   , KC_ESC , GUI_ENT}
    },
    ...
    */
    [_LOWER] = {
      ...
      { _______, RESET , _______, _______, _______, LFMOUSE , LFMOUSE,RAISE  , _______, _______, _______, _______}
    },
    ...
    */
    [_RAISE] = { /* RAISE */
      ...
      { _______, RESET  , _______, _______, LOWER  , MOUSE  , MOUSE  , _______, _______, _______, _______, _______}
    },
